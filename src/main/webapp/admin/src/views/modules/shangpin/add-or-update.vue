        ...
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="游戏分类" prop="shangpinTypes">
                        <el-select v-model="ruleForm.shangpinTypes" :disabled="ro.shangpinTypes" placeholder="请选择游戏分类">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="游戏分类" prop="shangpinValue">
